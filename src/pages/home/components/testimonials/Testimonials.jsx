...
import { ChevronLeft, ChevronRight, Star, Quote, Building, Home, HardHat, Construction, Shield, Award, Facebook, Instagram, Linkedin } from 'lucide-react';
  ...
  const testimonials = [
    {
      ...
      content: "BuagoPula built our dream home in Harare with exceptional quality and attention to detail. Their team was professional, on-time, and within budget. Highly recommended!",
      rating: 5,
      bgImage: project01,
    ...
    },
    {
      ...
      content: "Our commercial complex was completed 3 weeks ahead of schedule. The quality of work is outstanding and their project management was excellent throughout.",
      rating: 5,
      bgImage: project02,
      serviceIcon: <Building className="w-5 h-5" style={{ color: colors.navy }} />
    },
    {
      id: 3,
      name: "Thompson Family",
      role: "Home Renovation & Extension",
      content: "Complete renovation of our family home exceeded expectations. The team was clean, respectful, and delivered exactly what we envisioned. Truly professional.",
      rating: 5,
      bgImage: project03,
      serviceIcon: <HardHat className="w-5 h-5" style={{ color: colors.navy }} />
    },
    {
      id: 4,
      name: "Zimbabwe Development Trust",
      role: "Infrastructure Project",
      content: "Road construction project completed with precision and durability. BuagoPula's expertise in infrastructure is unmatched in the region. Reliable partner.",
      rating: 5,
      bgImage: project04,
      serviceIcon: <Construction className="w-5 h-5" style={{ color: colors.navy }} />
    },
    {
      id: 5,
      name: "Makoni Enterprises",
      role: "Project Management Client",
      content: "Their project management service saved us 20% on construction costs while maintaining top quality. Expert advice and flawless execution.",
      rating: 5,
      bgImage: project05,
    ...
    },
    {
      ...
      content: "From design to completion, BuagoPula delivered our unique custom home perfectly. Their attention to detail and customer service was exceptional.",
      rating: 5,
      bgImage: project06,
      serviceIcon: <Shield className="w-5 h-5" style={{ color: colors.navy }} />
    }
  ];
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
          <Building className="w-48 h-48" style={{ color: `${colors.navy}1A` }} />
        </div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="text-center mb-8">
          ...
          >
            Hear from satisfied clients across Zimbabwe who trusted BuagoPula Construction for their building projects
          </p>
        </div>
          ...
          {testimonials.map((_, index) => (
            <button
              ...
              className={`transition-all duration-300 rounded-full ${
                currentIndex === index ? 'w-8 h-1.5 shadow-lg' : 'w-2 h-2 hover:scale-125'
              }`}
              style={{
                backgroundColor: currentIndex === index ? colors.orange : colors.grayLight
              }}
        ...
        <div className="text-center mt-8">
          ...
          <div className="mt-4">
            <p 
              ...
              style={{ color: colors.grayDark }}
            >
              Trusted by <span style={{ color: colors.orange, fontWeight: 'bold' }}>250+</span> satisfied clients across Zimbabwe
            </p>
            <div className="flex items-center justify-center gap-2 mt-2 text-xs">
              {['Residential', 'Commercial', 'Infrastructure'].map((service, index) => (
